...
public class Driver 
{
	private BinarySearchTree<FoodItems> foodDictionary;
	...
	public Driver()
	{
		foodDictionary = new BinarySearchTree<FoodItems>();
		inFile = null;
	}
	...
	public void append (FoodItems nDictionary)
	{
		System.out.println("\n\nNew Food Added.......\n");
	...
	public void search()
	{
		...
		FoodItems a = new FoodItems(searchedFoodItem);
		Node<FoodItems> b = new Node<FoodItems>(a);
		Node<FoodItems> foundNode = foodDictionary.binarySearch(b);
		if (foundNode != null)
		{
